...
echo "$($PSQL "SELECT name FROM teams FULL JOIN games ON teams.team_id = games.game_id WHERE round='Final' AND year=2018")"
...
echo "$($PSQL "SELECT year, name FROM teams RIGHT JOIN games ON teams.team_id = games.game_id WHERE round='Final' ORDER BY year")"
